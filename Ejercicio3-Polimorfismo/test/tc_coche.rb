...
class CocheTest < Test::Unit::TestCase
  ...
  def test_incremento_precio
    ...
    # el assert dará error por temas de memoria...
    assert_equal([52638.5, 100000.5, 987.5], incrementar_precio(@coches, 0.5))
    assert_equal([1.5, 2.5, 3.5], incrementar_precio(@arryEntero, 0.5))
  end
